        ...
        <div class="w-4/5 max-w-full px-3 mt-0 lg:flex-none">
            <div
                ...
                <div class="border-black/12.5 mb-0 rounded-t-2xl border-b border-solid p-6 pt-4 pb-0">
                    <h6 class="capitalize font-semibold">Form Tambah User</h6>
                </div>
                <div class="flex-auto p-6">
                    ...
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <select name="role" id="role" required
                                    ...
                                    <option value="walikelas" {{ old('role') == 'walikelas' ? 'selected' : '' }}>Wali Kelas
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                <label for="password"
                                    class="block text-sm font-semibold py-2 text-slate-700 mb-1">Password</label>
