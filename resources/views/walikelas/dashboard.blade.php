                        ...
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p
                                    ...
                                    Total Siswa</p>
                                <h5 class="mb-2 font-bold mt-5 dark:text-white">50 Siswa</h5>
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p
                                    class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">
                                    Total Siswa Beasiswa</p>
                                <h5 class="mb-2 mt-5 font-bold dark:text-white">20 Siswa</h5>
                                {{-- <p class="mb-0 dark:text-white dark:opacity-60">
                        ...
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p
                                    class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">
                                    Walikelas</p>
                                <h5 class="mb-2 mt-5 font-bold dark:text-white">10 Orang</h5>
                                {{-- <p class="mb-0 dark:text-white dark:opacity-60">
                        ...
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p
                                    class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">
                                    Data Ekonomi</p>
                                <h5 class="mb-2 mt-5 font-bold dark:text-white">10 dari 50 Siswa</h5>
                                {{-- <p class="mb-0 dark:text-white dark:opacity-60">
